...
export const ServiceCard = ({ service }) => {
  ...
  return (
    <Card className="service-card bg-zinc-900 border-purple-600/20 hover:border-purple-500 transition-all duration-300 hover:shadow-[0_0_30px_rgba(168,85,247,0.3)] hover:-translate-y-2 group cursor-pointer">
